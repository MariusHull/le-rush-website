              ...
              <div className="container">
                  ...
                  <div className="row center">
                      <h5 className="header col s12 light">
                          Un festival de courts-métrages étudiants le temps d’un week-end rassemblant un concours entre
                  ...
                  <div className="row center hide-on-small">
                      <Link to="deroulement" id="download-button"
                          className="espaceDroite btn-large waves-effect waves-light teal lighten-1">Déroulement</Link>
                      <Link to="inscription" id="download-button"
                          className="espaceDroite btn-large waves-effect waves-light teal lighten-1 pulse">S'inscrire
                      </Link>
                      <Link to="contacts" id="download-button"
                          className="espaceDroite btn-large waves-effect waves-light teal lighten-1">Contacts</Link>
      ...
      <div className="container">
          <div className="section">
                  ...
                  <div className="col s12 m4">
                      <div className="icon-block">
                          ...
                          <p className="light justifier">
                              Le festival se déroule sur le campus de CentraleSupélec qui comprend des installations de
                              pointe.
                  ...
                  <div className="col s12 m4">
                      <div className="icon-block">
                          ...
                          <p className="light justifier">
                              ...
                              Mesurez vous à eux sans relâche durant la compétition, puis vous pourrez échanger avec eux
              ...
              <div className="container">
                  ...
                  <div className="row center">
                      <h5 className="header col s12 light">
                          Le Rush 3ème édition se déroulera le week-end du 29 février - 1 mars 2020 sur le campus de
                          CentraleSupélec
                      </h5>
                  </div>
                  <div className="row center">
